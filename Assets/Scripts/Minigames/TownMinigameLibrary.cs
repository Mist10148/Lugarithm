...
public static class TownMinigameLibrary
{
    ...
    static MinigameStationDef[] Tutorial() => new[]
    {
        ...
        Puzzle("tut_crates", "Capiz Route", MinigamePuzzleKind.CrateStack, PuzzlePurple,
            "Arrange the Capiz route cards into a safe travel order before the jeepney leaves the garage.",
            "Order each route step before departure."),
